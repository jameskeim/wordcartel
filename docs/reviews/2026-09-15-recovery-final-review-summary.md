...
Branch: `fix/recovery-safety`, based on `9e409c0`. Changes remain uncommitted.
...
Implementation, documentation and reviews are complete. Commit, merge and push require
separate user authorization and have not been performed for this effort.
