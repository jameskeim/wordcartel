...
Current status: implementation and polish committed as b53973e and merged into main
with user authorization on 2026-09-17. Both final reviews return GO; all 45 source
hashes match and the merged suite passed 2,643 tests (seven ignored). See the
[merge verification](2026-09-17-recovery-merge.md). No push performed.
...
2026-09-17: user-authorized commit/merge completed; see the merge verification above.
