...
Status: complete technical proposal, revision 3, awaiting independent re-review.
...
## Technical proposal for review — revision 3
...
with named platform flag constants and reject reparse/nonregular handles. A validated
...
Both e2e step and step_timed use these same boundaries. No IO or wait in render/reduce.
