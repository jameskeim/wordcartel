...
> Plan status: CLEAN — Codex GO ×2 (honest 3-RED/3-green accounting verified) + Fable
> READY (every probe literal independently re-generated byte-exact against the locked
> repar 1.0.0; the RED accounting empirically confirmed; the journey-collision fix
> verified with save_settings still the final registration), 2026-07-05.
