...
- [ ] **Step 6: move the seven tests** into a new test module at the bottom of jobs_apply.rs whose header is exactly:
...
- Totals: 24 tests moved (7 jobs_apply + 7 session_restore + 10 prompts incl. :5113-:5127 + 0 search_ui), 115 stay; suite total stays 975 with 0 failures at every commit.
