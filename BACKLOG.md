...
| H34 | cursor_style restore_caret_if_written_gated_by_latch flake — 1/30, then 0/200 | watch | bug | TBD |  | Seen once (1/30) on a deliberately-broken tree; 0/200 on clean main — rate bounded <1.5% |
